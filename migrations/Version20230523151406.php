 ...
 */
final class Version20230523151406 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_teams (user_id INT NOT NULL, team_id INT NOT NULL, INDEX IDX_7400D900296CD8AE (team_id), INDEX IDX_7400D900A76ED395 (user_id), PRIMARY KEY(user_id, team_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
